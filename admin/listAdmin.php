...
$sql="select id,username,email from biogas_admin order by id asc limit {$offset},{$pageSize}";
$rows=fetchAll($sql);

if(!$rows){
    alertMes("对不起, 没有管理员, 请先添加!", "addAdmin.php");
}
?>
...
<script type="text/javascript">
    ...
    function delAdmin(id){
        if(window.confirm("确定删除? 删除后无法恢复!!!")){
